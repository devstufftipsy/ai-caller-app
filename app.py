...
def generate_audio_stream(text_to_speak):
    """A generator function that yields audio chunks from ElevenLabs with robust error handling."""
    ELEVENLABS_API_KEY = os.environ.get("ELEVENLABS_API_KEY")
    VOICE_ID = "21m00Tcm4TlvDq8ikWAM" # A standard, high-quality voice
    ...
    try:
        with httpx.stream("POST", url, json=data, headers=headers, timeout=30) as r:
            # Check for errors from the ElevenLabs API
